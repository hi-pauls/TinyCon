...
namespace TinyCon
{
    ...
    #if USE_NEOPIXEL
        void SetRgbRed(LedEffects effect, uint8_t value = 0) { SetRgbColor(effect, value, RgbRedEffect, RgbRedValue); }
        void SetRgbGreen(LedEffects effect, uint8_t value = 0) { SetRgbColor(effect, value, RgbGreenEffect, RgbGreenValue); }
        void SetRgbBlue(LedEffects effect, uint8_t value = 0) { SetRgbColor(effect, value, RgbBlueEffect, RgbBlueValue); }
    #endif
    ...
    private:
        ...
        void SetRgbColor(LedEffects nextEffect, uint8_t nextValue, LedEffects& currentEffect, uint8_t& currentValue);
