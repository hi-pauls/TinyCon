...
public:
    void Init(TwoWire& i2c, int8_t controller);
    void Update();
    [[nodiscard]] ControllerTypes GetType() const { return (Seesaw.Present && Enabled) ? ControllerTypes::Seesaw : ControllerTypes::None; }
    [[nodiscard]] int8_t GetAxisCount() const { return (Seesaw.Present && Enabled) ? sizeof(Seesaw.Axis) / sizeof(Seesaw.Axis[0]) : 0; }
    [[nodiscard]] int8_t GetButtonCount() const { return (Seesaw.Present && Enabled) ? sizeof(Seesaw.Buttons) / sizeof(Seesaw.Buttons[0]) : 0; }
